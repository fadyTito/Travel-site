...
var StickyHeader = function () {
  function StickyHeader(trigger) {
    ...
    this.headerLinks = (0, _jquery2.default)('.header__menu-content__nav a');
        ...
        new Waypoint({
          ...
          handler: function handler(direction) {
            if (direction == "down") {
              ...
              (0, _jquery2.default)(matchingHeaderLink).addClass("isCurrent-link");
            }
          },
          offset: '25%'
        });
...
var RevealOnScroll = function () {
  ...
  _createClass(RevealOnScroll, [{
    ...
    value: function hideInitially() {
      this.itemsToReveal.addClass('hide');
    }
  }, {
    key: 'createWaypoints',
      ...
      this.itemsToReveal.each(function () {
        ...
        new Waypoint({
          ...
          handler: function handler() {
            (0, _jquery2.default)(currentItem).addClass("reveal");
          },
